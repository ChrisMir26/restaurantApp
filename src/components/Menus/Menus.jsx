...
const Menus = () => {
  ...
  return (
    ...
    <div className={styleMenu.menusCnt}>
        ...
        <p onClick={() => handleOptionClick('bondi')} className={selectedMenu === 'bondi' ? styleMenu.optionActive : ""}>Bondi</p>
        <p onClick={() => handleOptionClick('cronulla')} className={selectedMenu === 'cronulla' ? styleMenu.optionActive : ""}>Cronulla</p>
        </div>
        <div
  className={
    styleMenu.menusBox +
